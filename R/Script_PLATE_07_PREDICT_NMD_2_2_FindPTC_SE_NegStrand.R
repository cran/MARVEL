#' @title Find Premature Terminal Codon (PTC) for Skipped-Exon (SE) Located on the Negative Strand of the Transcript
#'
#' @description
...
FindPTC.SE.NegStrand <- function(MarvelObject, tran_id, gene_id) {
    ...
    alt.exon.start <- as.numeric(strsplit(., split=":", fixed=TRUE)[[1]][3])
